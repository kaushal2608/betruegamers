  ...
  async getFriendsList(userId) {
    return await appCache.getOrSet(`friends:list:${userId}`, async () => {
      try {
        ...
        return [
          { id: 'u-sarah', username: 'NeoNova', email: 'sarah@betruegamers.com', avatar_url: 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?auto=format&fit=crop&w=200&q=80', role: 'COACH', experience_level: 'Semi-Pro' }
        ];
      }
    }, 60);
  },
